...
const Assessment = () => {
            ...
            <div className="flex flex-col md:flex-row items-center  md:gap-12 mb-12 max-w-7xl mx-auto  p-6 sm:px-8">
                ...
                <div className="md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left space-y-4">
                    <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-blue-600 leading-tight">
                        ...
                        trusted certified assessments<br />
                    ...
                    <div className="flex justify-center gap-4">
                        ...
                        <button className="px-6 sm:px-8 py-3 w-fit bg-blue-600 text-white border-blue-600 rounded-lg hover:bg-blue-600 hover:text-white">
                            Get a Demo
                        </button>
                    </div>
                </div>
    ...
    <div className="w-full md:w-1/2 mt-6 md:mt-0">
        <img
            src="../comp.svg" // Adjust the image source path as needed
            alt="Question filter example"
            className=" w-full h-auto max-w-full object-contain"  // Ensure the image doesn't stretch
        />
    </div>
