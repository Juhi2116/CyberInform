...
const Resourcelib = () => {
  return (
    <div className="bg-white py-12 px-6 md:px-12 lg:px-24">
      {/* Resources Section */}
      <div className="flex flex-col lg:flex-row items-center max-w-6xl m-auto">
        {/* Left Text Section */}
        <div className="lg:w-1/2  lg:text-left lg:m-8">
          <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold text-gray-900">
            Our <span className="text-blue-600">Resources</span>
          </h1>
          <p className="text-gray-600 mt-4 font-semibold text-sm lg:text-xl leading-relaxed">
